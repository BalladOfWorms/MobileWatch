#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rev 288b — zone pass: Ro'Maeve.
Zone string per zones.json = 'RoMaeve' (no apostrophe).
...
NM = [
    ("Nightmare Vase",    "76-78", "Lottery (Magic Flagon)"),
    ("Shikigami Weapon",  "77-80", "Timed (21 hrs - 21 hrs 15 min)"),
    ("Martinet",          "72-74", "Timed (2 hrs)"),
    ("Nargun",            "~78",   "Timed (unknown)"),
    ("Rogue Receptacle",  "67",    "Lottery (Magic Flagon)"),
    ("Eldhrimnir",        SKIP,    "Quest (Orastery Woes)"),
    ("Mokkurkalfi",       SKIP,    "Mission (Bastok 7-1)"),
    ("Fired Urn",         SKIP,    "Always spawned; immediate respawn"),
    ("Lode Golem",        SKIP,    "Always spawned; immediate respawn"),
    ("Steely Weapon",     SKIP,    "Always spawned; immediate respawn"),
    ("Douma Weapon",      "125",   "UNM (2,100 Unity Accolades)"),
    ("Mimic King",        SKIP,    "Voidwatch (Ashen stratum abyssite II + Voidstone)"),
]

ADV = [
    ("Killing Weapon",     "60-64"),
    ("Ominous Weapon",     "61-65"),
    ("Cursed Puppet",      "65-69"),
    ("Cannonball",         "66-70"),   # page writes "Cannonball (Monster)"
    ("Thunder Elemental",  "67-69"),
    ("Water Elemental",    "67-69"),
    ("Magic Flagon",       "68-70"),
    ("Mythril Golem",      "68-70"),
    ("Apocalyptic Weapon", "78-80"),
    ("Infernal Weapon",    "79-81"),
    ("Darksteel Golem",    "80-82"),
]
...
# ---------------------------------------------------------------- apply
WRITES_ZONE = [
    ('fired urn',         None),   # ZERO zones before; "always spawned", no published level
    ('lode golem',        None),
    ('steely weapon',     None),
    ('thunder elemental', '67-69'),
    ('water elemental',   '67-69'),
...
WRITES_LEVEL = [
    ('nargun',              None,    '~78'),    # nmlv already ~78
    ('mythril golem',       None,    '68-70'),
    ('darksteel golem',     None,    '80-82'),
    ('ominous weapon',      '61-63', '61-65'),
    ('apocalyptic weapon',  '76-80', '78-80'),
    # the page's "Cannonball (Monster)" is the fam=Bomb twin; the bare `cannonball`
    # stub keeps its zero zones (ixtab precedent, rev 277)
    ('cannonball (monster)', '67-68', '66-70'),
]
LV_EXTEND = [('cannonball (monster)', [66, 70])]   # rule 9
