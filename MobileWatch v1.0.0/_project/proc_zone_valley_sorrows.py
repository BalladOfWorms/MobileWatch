#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rev 293b — zone pass: Valley of Sorrows.
Zone string per zones.json = 'Valley of Sorrows'.
...
NM = [
    ("Adamantoise",    "72-74", "Forced (trade Blue Pondweed to ???)"),
    ("Aspidochelone",  "85-88", "Forced (trade Red Pondweed to ???)"),
    ("Tolba",          "135",   "UNM (3,100 Unity Accolades)"),
]

ADV = [
    ("Air Elemental",    "66-68"),
    ("Fire Elemental",   "66-68"),
    ("Velociraptor",     "66-69"),
    ("Peryton",          "69-72"),
...
# ---------------------------------------------------------------- apply
WRITES_ZONE = [('air elemental', '66-68'), ('fire elemental', '66-68')]
# NOT WRITTEN: adamantoise 72-75 -> 72-74. Rule 107/116 with the rev-279 tie-breaker: the stored
# range CONTAINS the page's, and the record's own `nmlv` reads 72-75 and BACKS the range. File wins.
